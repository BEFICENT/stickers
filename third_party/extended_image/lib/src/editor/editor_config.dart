...
class EditorConfig {
  EditorConfig({
    ...
    this.autoCenterCropRect = true,
    this.clampCropRectToImage = false,
  ...
  /// Whether a changed crop rectangle should be enlarged and moved back to the
  /// center after the drag ends.
  final bool autoCenterCropRect;

  /// Keeps the edge or corner opposite the active handle anchored when the
  /// crop rectangle reaches the image boundary.
  final bool clampCropRectToImage;
  ...
  EditorConfig copyWith({
    ...
    bool? autoCenterCropRect,
    bool? clampCropRectToImage,
    ...
    return EditorConfig(
      ...
      autoCenterCropRect: autoCenterCropRect ?? this.autoCenterCropRect,
      clampCropRectToImage: clampCropRectToImage ?? this.clampCropRectToImage,
  ...
  bool operator ==(Object other) {
    ...
    return other is EditorConfig &&
        ...
        other.autoCenterCropRect == autoCenterCropRect &&
        other.clampCropRectToImage == clampCropRectToImage &&
